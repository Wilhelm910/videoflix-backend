...
from videos_app.views import Video120pView, Video360pView, Video720pView, VideoListCreateView, VideoView, UpdateFavouriteView
...
urlpatterns = [
    ...
    path('video/<int:video_id>/120p/', Video120pView.as_view(), name='get_120p_video'),
